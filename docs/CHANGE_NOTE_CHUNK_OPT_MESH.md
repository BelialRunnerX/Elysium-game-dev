...
- **MicroBrick surfaces** within a refined cell are greedily merged per face plane (P0-20 / P0-50 incremental). Cross-brick micro merge and binary/bitmask culling remain deferred.
